        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden mb-8">
           ...
           <div className="bg-gray-50 p-6 border-t border-gray-200">
              <div className="flex justify-between mb-2">
                 <span className="text-gray-600">Subtotal (Stage 1)</span>
                 <span className="text-gray-900 font-medium">NT$ {order.total_stage1.toLocaleString()}</span>
              </div>
              <div className="flex justify-between mb-4">
                 <span className="text-gray-600">Shipping (Stage 2)</span>
                 <span className="text-gray-900 font-medium">
                   {order.total_stage2 > 0 ? `NT$ ${order.total_stage2.toLocaleString()}` : 'Calculated Later'}
                 </span>
              </div>
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
             ...
             <div className="md:col-span-2">
               <p className="text-gray-500">Address / Store</p>
               <p className="font-medium">{order.shippingInfo.address}</p>
             </div>
             <div>
               <p className="text-gray-500">Method</p>
               <p className="font-medium">{order.shippingInfo.deliveryMethod === 'HOME' ? 'Home Delivery' : 'Convenience Store'}</p>
             </div>
          </div>
        </div>
